...
try {
const response = await api.get(`/vehiclelisting/0/Admin/SoldCars`);
...
<section className="car-details">
	...
	<div className="container">
		<div className="view-post-panel mid-table mt-4">
			<h3 className="main-heading py-3">Sold Cars</h3>
				...
				<div className="carbid-gallery-panel py-4">
					<div className="row">
						...
						<div className="col-md-12">
							<p className="text-center text-danger">No Sold Cars</p>
						</div>
						) : (
						posts.map(post => (
						<div key={post.id} className="col-lg-4 col-12">
							<a href={`/sold-car-details/${post.Vehicle_Id}`}>
