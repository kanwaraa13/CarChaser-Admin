...
console.log(fetchpriceData.Bid_Amount);
} else {
...
<section class="car-details">
	...
	<div class="container mt-5">
		...
		<div>
			{fetchprice && Object.keys(fetchprice).length > 0 && (
			<>
			<div class="top-bid-price">
				<h4>Winner Bid Price :</h4>
				<h6 class="pl-3">${formatBidAmount(fetchprice.Bid_Amount)}</h6>
			</div>
			<div class="top-bid-price">
				<h4> Winner Selection Date :</h4>
				<h6 class="pl-3">{fetchprice.Winner_Declare_Date}</h6>
			</div>
			<div class="top-bid-price">
				<h4>Winner : </h4>
				<h6 class="pl-3"><a data-toggle="modal" data-target=".bd-example-modal-lg11">{fetchprice.Dealer_Fname} {fetchprice.Dealer_Lname}</a></h6>
			</div>
			</>
			)}
		</div>
