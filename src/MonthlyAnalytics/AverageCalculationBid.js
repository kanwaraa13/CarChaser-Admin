...
export const AverageCalculationBid = () => {
  ...
  const handleClick = async (event) => {
	  ...
	  try {
		const response = await api.get(`/admin/total-number-of-car/AverageCalculationOfWinningBids/${selectedYear}/${selectedMonth}`);
        ...
        <div className="container">
          <div className="monthy-report">
            <form>
              <div className="form-group">
                <label htmlFor="exampleFormControlSelect1" className="mr-3">Average calculation of winning bids in</label>
          ...
          {isdisplay && (
				<div>
				  ...
				  <h3>Average Calculation Of Winning Bids In {displaymonth}, {displayyear}</h3>
