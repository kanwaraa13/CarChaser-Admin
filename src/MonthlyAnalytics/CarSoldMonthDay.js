...
export const CarSoldMonthDay = () => {
  ...
  const fetchData = async (month, year) => {
    try {
      ...
      const response = await api.get(`/admin/total-number-of-car/CarsSoldPerDayOfTheMonth/${year}/${month}`);
      ...
      const yValues = data.map(item => item.cars_sold);
      ...
      <div className="mid-panel mt-3">
        <div className="container">
          <div className="monthy-report">
            <h3 className="main-heading text-center">Cars Sold Per Day Of The Month</h3>
            <form>
              <div className="form-group">
                <label htmlFor="exampleFormControlSelect1" className="mr-3">Cars sold per day of the month</label>
                ...
                <label htmlFor="exampleFormControlSelect2" className="mr-3">Select Year:</label>
