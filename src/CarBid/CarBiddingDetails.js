...
import api from '../api';
export const  CarBiddingDetails = () => {
...
console.log(sellerData.Seller_FName);
setSellerFirstName(sellerData.Seller_FName);
} catch (error) {
...
<section class="car-details">
	<AdminNav />
	<div class="container">
		<div class="top-bid-price mt-3">
			<h4>Seller :</h4>
			<h6 class="pl-3"> <a data-toggle="modal" data-target=".bd-example-modal-lg11">{sellerFirstName}</a></h6>
		</div>
		<div class="top-bid-price">
			<h4>Total Bids :</h4>
			<h6 class="pl-3"> <a href={`/total-bid/${Vehicle_Id}`}>{bidcount}</a></h6>
		</div>
		<div class="row py-3">
