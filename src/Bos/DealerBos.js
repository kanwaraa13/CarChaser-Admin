...
const dealerdata = response.data.vehiclebidlisting[0];
console.log(dealerdata)
const dealerFname = dealerdata.Dealer_Fname;
const DealerLname = dealerdata.Dealer_Lname;
const DealerAddress = dealerdata.Dealer_Address;  
const DealerPhone = dealerdata.Dealer_Phone;   
const DealerEmail = dealerdata.Dealer_Email; 
setDealerName(dealerFname);
setLastName(DealerLname);
setAddress(DealerAddress);
setDealerPhone(DealerPhone);
setEmail(DealerEmail);
} catch (error) {
...
try {
const response = await api.post(`/seller/updatedealerbos/${Vehicle_Id}`);
			...
			<form method="post" action="#">
				<div class="container-fluid">
					...
					<div class="seller-purchaser px-3 py-4">
						<h3 class="main-headding mb-4"> Dealer BOS</h3>
						<div class="row print-info">
							<div class="col-lg-6 seller-bill dealer-sellerinfo">
								<div class="d-flex">
							...
							<div class="col-lg-6 seller-bill">
								<div class="d-flex">
									<h4 class="py-4"> PURCHASER</h4>
								</div>
								<div class="newbill-form">
									<div class="new-group">
										<p class="m-0">Name :-</p>
										<div class="form-group newbill-border">                        
											<input type="text" name="name1" class="form-control" id="#" value={`${dealername}${lastname} `}/>
										</div>
									</div>
									<div class="new-group">
										<p class="m-0">Address :-</p>
										<div class="form-group newbill-border">                        
											<input type="text" name="name1" class="form-control" id="#" value={adress}/>
										</div>
									</div>
									<div class="new-group">
										<p class="m-0">City/Prov/PC :-</p>
									...
									<div class="new-group">
										<p class="m-0">Phone :-</p>
										<div class="form-group newbill-border">                        
											<input type="text" name="name1" class="form-control" id="#"  value={phone}/>
										</div>
									</div>
									<div class="new-group">
										<p class="m-0">Email :-</p>
										<div class="form-group newbill-border">                        
											<input type="text" name="name1" class="form-control" id="#" value={email} />
										</div>
									</div>
									<div class="new-group">
										<p class="m-0">Signature :-</p>
										<div class="form-group newbill-border">                        
											<input type="text" name="name1" class="form-control" id="#" value={dealername}/>
										</div>
									</div>
								</div>
							</div>
	...
	<div className='container-fluid mb-4'>
		<div className='row'>
			<div className='com-md-12'>
				<button type="button" className="btn btn-primary ml-3 text-center" onClick={downloadPdf}>
				Pdf Download
				</button>
			</div>
		</div>
